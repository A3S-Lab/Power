...
const MODULE_NAME: &str = "a3s_power_biased_activation_f32_v1";
...
impl ChannelBiasActivation {
    fn new(input: &Layout, bias: &Layout, activation: Activation) -> Result<Self> {
        ...
        Ok(Self {
            ...
            elements,
            channels: u32::try_from(dimensions[1])
                .map_err(|_| candle_core::Error::Msg("channel count exceeds u32".into()))?,
            spatial_elements: u32::try_from(spatial_elements)
...
impl CustomOp2 for ChannelBiasActivation {
    ...
    fn cuda_fwd(
        ...
        builder.arg(&self.spatial_elements);
        builder.arg(&divisor);
        builder.arg(&offset);
        builder.arg(&scale);
        unsafe {
...
impl BiasedGatedHardSigmoid {
    fn new(
        ...
        Ok(Self {
            ...
            elements,
            channels: u32::try_from(multiplicand_dimensions[1])
                .map_err(|_| candle_core::Error::Msg("channel count exceeds u32".into()))?,
            spatial_elements: u32::try_from(spatial_elements)
                .map_err(|_| candle_core::Error::Msg("spatial size exceeds u32".into()))?,
            layout,
...
mod tests {
    ...
    fn biased_relu_and_gelu_are_byte_exact_with_existing_cuda_sequences() {
